        ...
        <Container>
            <div>
                ...
                <menu class="flex space-x-1 overflow-x-auto pb-4 pt-1 mt-3">
                    <li><Phill :filled="!selectedTopic" :href="route('posts.index', { query: searchForm.query})">All Posts</Phill></li>
                    <li v-for="topic in topics" :key="topic.id">
                        <Phill :filled="topic.id === selectedTopic?.id" :href="route('posts.index', { topic: topic.slug, query: searchForm.query })">
                        {{ topic.name }}
                        </Phill>
                    </li>
                </menu>
